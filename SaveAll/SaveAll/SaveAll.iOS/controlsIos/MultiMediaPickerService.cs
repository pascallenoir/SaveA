...
namespace SaveAll.iOS.controlsIos
{
    public class MultiMediaPickerService : IMultiMediaPickerService
    {
        ...
        TaskCompletionSource<IList<Patrimoine>> mediaPickTcs;
        ...
        async Task<IList<Patrimoine>> PickMediaAsync(string title, PHAssetMediaType type)
        {

            mediaPickTcs = new TaskCompletionSource<IList<Patrimoine>>();
